...
namespace osu.Game.Scoring
{
    public class ScoreManager : IModelManager<ScoreInfo>, IModelImporter<ScoreInfo>, IModelFileManager<ScoreInfo, ScoreFileInfo>, IModelDownloader<IScoreInfo>
    {
        ...
        public ScoreManager(RulesetStore rulesets, Func<IBeatmapManager<BeatmapSetInfo>> beatmaps, Storage storage, IAPIProvider api, IDatabaseContextFactory contextFactory, Scheduler scheduler,
