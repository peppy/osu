...
namespace osu.Game.Scoring.Legacy
{
    ...
    public class DatabasedLegacyScoreDecoder : LegacyScoreDecoder
    {
        ...
        protected override IWorkingBeatmap GetBeatmap(string md5Hash) => beatmaps.GetWorkingBeatmap(beatmaps.QueryBeatmap(b => !b.BeatmapSet.DeletePending && b.MD5Hash == md5Hash));
    }
}
