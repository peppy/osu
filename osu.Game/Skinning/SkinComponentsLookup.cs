...
namespace osu.Game.Skinning
{
    ...
    /// </summary>
    public class SkinComponentsLookup : ISkinComponentLookup, IEquatable<SkinComponentsLookup>
    {
        /// <summary>
        ...
        public SkinComponentsLookup(TargetArea target, RulesetInfo? ruleset = null)
        {
            Target = target;
            Ruleset = ruleset;
        }
        ...
        public bool Equals(SkinComponentsLookup? other)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((SkinComponentsLookup)obj);
        }
