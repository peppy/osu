...
namespace osu.Game.Beatmaps
{
    ...
    [MapTo("BeatmapSet")]
    public class RealmBeatmapSetInfo : RealmObject, IHasGuidPrimaryKey, IHasRealmFiles, ISoftDelete, IEquatable<RealmBeatmapSetInfo>, IBeatmapSetInfo
    {
        [PrimaryKey]
        ...
        public IList<RealmBeatmapInfo> Beatmaps { get; } = null!;
        ...
        public bool Equals(RealmBeatmapSetInfo? other)
        {
        ...
        public bool Equals(IBeatmapSetInfo? other) => other is RealmBeatmapSetInfo b && Equals(b);
