...
namespace osu.Game.Screens.Select.Carousel
{
    public class SetPanelContent : CompositeDrawable
    {
        ...
        private IEnumerable<DifficultyIcon> getDifficultyIcons()
        {
            ...
            return new DifficultyIcon[] { };
            // return beatmaps.Count > maximum_difficulty_icons
            //     ? (IEnumerable<DifficultyIcon>)beatmaps.GroupBy(b => b.BeatmapInfo.PerformRead(d => d.RulesetID))
            //                                            .Select(group => new FilterableGroupedDifficultyIcon(group.ToList(), group.Last().BeatmapInfo.PerformRead(b => b.Ruleset.Detach())))
