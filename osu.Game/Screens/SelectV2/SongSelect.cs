...
namespace osu.Game.Screens.SelectV2
{
    ...
    public abstract partial class SongSelect : OsuScreen, IKeyBindingHandler<GlobalAction>, ISongSelect
    {
        ...
        {
            foreach (var item in GetPrimaryActions(beatmap))
                yield return item;

            yield return new OsuMenuItemSpacer();

            foreach (var item in GetSecondaryActions(beatmap))
                yield return item;

            yield return new OsuMenuItemSpacer();
        }

        public virtual IEnumerable<OsuMenuItem> GetPrimaryActions(BeatmapInfo beatmap)
        {
        ...
        public virtual IEnumerable<OsuMenuItem> GetSecondaryActions(BeatmapInfo beatmap)
        {
