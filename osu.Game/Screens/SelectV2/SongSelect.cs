...
namespace osu.Game.Screens.SelectV2
{
    ...
    public abstract partial class SongSelect : OsuScreen, IKeyBindingHandler<GlobalAction>, ISongSelect
    {
        ...
        /// </summary>
        public virtual IEnumerable<MenuItem> CreateMenuItemsForBeatmap(BeatmapInfo beatmap) => new[]
        {
            new OsuMenuItem("Select", MenuItemType.Highlighted, () => SelectAndStart(beatmap)),
        };
