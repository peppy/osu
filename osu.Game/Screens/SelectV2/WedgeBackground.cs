...
namespace osu.Game.Screens.SelectV2
{
    ...
    {
        public float FinalAlpha { get; init; } = 0.4f;
        ...
        private void load(OverlayColourProvider colourProvider)
        {
            ...
            InternalChildren = new Drawable[]
            {
                ...
                new Box
                {
                    ...
                    RelativeSizeAxes = Axes.Both,
                    Width = 0.3f,
                    Colour = ColourInfo.GradientHorizontal(colourProvider.Background5.Opacity(0.8f), colourProvider.Background5.Opacity(FinalAlpha)),
                },
            };
        }
    }
