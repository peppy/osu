...
{
    public partial class PanelBeatmapSet : Panel, IHasContextMenu
    {
        ...
        protected override void PrepareForUse()
        {
            ...
            if (songSelect != null)
            {
                // todo: this is totally incorrect, we need better ways to know the recommended & non-filtered beatmap in the set. possibly as part of the item model.
                var beatmap = beatmapSet.Beatmaps.First();

                mainContextItems.AddRange(songSelect.CreateMenuItemsForBeatmap(beatmap));
            }
        }
        ...
        public MenuItem[] ContextMenuItems
        {
            get
            {
                ...
                if (!Expanded.Value)
                    items.Add(new OsuMenuItem("Expand", MenuItemType.Highlighted, () => Carousel?.Activate(Item)));
                ...
                {
                    items.Add(new OsuMenuItem("Restore all hidden", MenuItemType.Standard, () =>
                    {
