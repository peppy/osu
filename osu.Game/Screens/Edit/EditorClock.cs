...
namespace osu.Game.Screens.Edit
{
    ...
    /// </summary>
    public class EditorClock : CompositeDrawable, IFrameBasedClock, IAdjustableClock
    {
        public double TrackLength => underlyingClock.TrackLength;

        private ControlPointInfo controlPointInfo => Beatmap.ControlPointInfo;

        public IBeatmap Beatmap { private get; set; }
        ...
        private void updateSeekingState()
        {
            if (seekingOrStopped.Value)
            {
                ...
                if (underlyingClock.Track?.IsRunning != true)
                {
