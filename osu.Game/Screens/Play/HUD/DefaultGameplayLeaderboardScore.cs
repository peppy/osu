...
{
    public partial class DefaultGameplayLeaderboardScore : GameplayLeaderboardScore
    {
        ...
        public override int? ScorePosition
        {
            get => scorePosition;
            set
            {
        ...
        public DefaultGameplayLeaderboardScore(IUser? user, bool tracked)
            : base(user, tracked)
        {
            AutoSizeAxes = Axes.X;
            Height = PANEL_HEIGHT;
