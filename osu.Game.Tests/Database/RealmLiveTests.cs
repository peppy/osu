...
namespace osu.Game.Tests.Database
{
    public class RealmLiveTests : RealmTest
    {
        ...
        public void TestLiveEquality()
        {
            ...
            {
                ILive<BeatmapInfo> beatmap = realmFactory.CreateContext().Write(r => r.Add(new BeatmapInfo(CreateRuleset(), new BeatmapDifficulty(), new BeatmapMetadata()))).ToLive();

                ILive<BeatmapInfo> beatmap2 = realmFactory.CreateContext().All<BeatmapInfo>().First().ToLive();
