...
namespace osu.Game.Tests.Visual.SongSelect
{
    ...
    public partial class TestSceneBeatmapCarouselV2 : OsuManualInputManagerTestScene
    {
        ...
        public void TestScrollPositionMaintainedOnAddSecondSelected()
        {
            ...
            AddStep("scroll to selected item", () => scroll.ScrollTo(scroll.ChildrenOfType<BeatmapCarouselSetPanel>().Single(p => p.Item!.Selected.Value)));

            AddUntilStep("wait for scroll finished", () => scroll.Current, () => Is.EqualTo(scroll.Target));

            AddStep("save selected screen position", () => positionBefore = carousel.ChildrenOfType<BeatmapCarouselSetPanel>().FirstOrDefault(p => p.Item!.Selected.Value)!.ScreenSpaceDrawQuad);
            ...
            AddAssert("select screen position unchanged", () => carousel.ChildrenOfType<BeatmapCarouselSetPanel>().Single(p => p.Item!.Selected.Value).ScreenSpaceDrawQuad,
