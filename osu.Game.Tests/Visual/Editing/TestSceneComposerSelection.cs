...
namespace osu.Game.Tests.Visual.Editing
{
    public partial class TestSceneComposerSelection : EditorTestScene
    {
        ...
        {
            var firstObject = new HitCircle { StartTime = 0 };
            var secondObject = new HitCircle { StartTime = 1000 };
